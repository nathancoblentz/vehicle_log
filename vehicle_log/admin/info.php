...
/*
    ...
    Administrative Info Page — Consolidates vehicle, service, and vendor reporting.
    Includes administrative actions (Delete) which are hidden in the standard info view.
*/
...
$title = 'Admin Information Center';
$hideNav = true; 
$requireAuth = true;
...
// Allow delete functionality in this admin view
$allow_delete = true;
...
$fuel_id_selection = $_GET['f_id'] ?? null;
