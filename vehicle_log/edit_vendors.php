...
<!-- Cannot Delete Vendor Modal -->
<div class="modal fade" id="cannotDeleteVendorModal" tabindex="-1" aria-labelledby="cannotDeleteVendorLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title" id="cannotDeleteVendorLabel">
                    <i class="fa-solid fa-triangle-exclamation me-2"></i>Cannot Delete Vendor
                </h5>
            ...
            <div class="modal-body">
                <p class="mb-2">
                    The vendor <strong id="cannotDeleteVendorName"></strong> cannot be deleted because it is
                    currently referenced by
                    <strong id="cannotDeleteVendorCount"></strong> maintenance record(s).
                </p>
                <p class="text-muted mb-0">
                    To delete this vendor, you must first remove or reassign all maintenance records that use it.
                </p>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const modal = document.getElementById('cannotDeleteVendorModal');
        if (!modal) return;
        modal.addEventListener('show.bs.modal', function (e) {
            const btn = e.relatedTarget;
            if (!btn) return;
            document.getElementById('cannotDeleteVendorName').textContent = btn.getAttribute('data-vendor-name') || '';
            document.getElementById('cannotDeleteVendorCount').textContent = btn.getAttribute('data-usage-count') || '0';
        });
    });
</script>
